...
const DEFINITIONS: Record<CatalogPageId, PageDefinition> = {
  ...
  reviews: definition(
    'Bewertungen',
    'Reviews',
    'Mehr als 300 Bewertungen auf zehn Portalen',
    'More than 300 reviews across ten platforms',
    'Immonation ist auf Google, Trustpilot, Immowelt und sieben weiteren Portalen mit eigenen Profilen vertreten. Direkte Quellen und Aggregate sind getrennt ausgewiesen.',
    'Immonation maintains profiles on Google, Trustpilot, Immowelt, and seven further platforms. Direct sources and aggregates are labelled separately.',
