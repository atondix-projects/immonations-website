    ...
    <div className="bg-background">
      ...
      <header className="border-border border-b">
        <div className="mx-auto w-full max-w-[1320px] px-5 pt-14 pb-12 sm:px-7 md:pt-20 md:pb-16 lg:px-12">
          ...
          <h1 className="hyphens-headline mt-7 max-w-[20ch] font-serif text-[2.6rem] leading-[1.02] font-medium tracking-[-0.03em] text-balance break-words md:text-[3.8rem] lg:text-[4.4rem]">
            {post.title}
          </h1>
