...
export async function ContactBooking({ embedded = false }: { embedded?: boolean }) {
  ...
  const body = (
    <div
      className={cn(
        'grid items-start gap-12 lg:grid-cols-[1.1fr_1fr] lg:gap-16',
        !embedded && CONTAINER,
      )}
    >
      <div className="flex flex-col gap-8">
        ...
        <p className="text-muted-foreground max-w-[60ch] text-[17px] leading-[1.6]">{t('text')}</p>
