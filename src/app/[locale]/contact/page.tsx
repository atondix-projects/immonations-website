      ...
      <section className="bg-muted/45 py-18 md:py-24">
        <div className={`${CONTAINER} grid gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16`}>
          ...
          <div className="lg:pt-4">
            ...
            <h2 className="hyphens-headline mt-4 max-w-[16ch] font-serif text-[2.1rem] leading-[1.06] font-medium tracking-[-0.025em] text-balance break-words md:text-[2.6rem]">
              {t('steps.title')}
            </h2>
